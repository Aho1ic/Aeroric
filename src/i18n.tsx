...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "ssh.passwordStorageHint":
      "Passwords are stored locally in Nezha connection settings and passed to system SSH via sshpass environment variables.",
    "ssh.connect": "Connect",
  ...
  zh: {
    ...
    "ssh.passwordStorageHint":
      "密码会保存在本机 Nezha 连接配置中，并通过 sshpass 环境变量传递给系统 SSH。",
    "ssh.connect": "连接",
    "ssh.disconnect": "断开",
