...
import {
  ...
  FileBreadcrumbs,
  MarkdownToc,
} from "./file-viewer/FileOutline";
import { renderMarkdownWithToc } from "./file-viewer/markdownPreview";
...
import { projectRelativeGitPath } from "./git-advanced/gitAdvancedState";
import {
  isMarkdownFile,
    ...
    >
      ...
      >
        ...
        <LspActionDialogs
          ...
          onApplyCodeAction={(action) => void handleApplyCodeAction(action)}
          onCloseCodeActions={() => setCodeActions(null)}
        />
      </div>
      ...
      >
        ...
        <LspActionStatusMessages
          ...
          codeActionSummary={codeActionSummary}
          codeActionCommandSummary={codeActionCommandSummary}
        />
        {inlineBlameError && (
          <span
